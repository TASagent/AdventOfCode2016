...
Console.WriteLine("Day 07 - Internet Protocol Version 7");
...
static bool SupportsTLS(string ipAddr)
{
...
static bool SupportsSSL(string ipAddr)
{
...
static bool HasABBA(string segment)
{
...
static IEnumerable<string> GetSequences(string ipAddr, bool hypernet)
{
...
static IEnumerable<string> GetBABSequences(string segment)
{
